...
#include <iostream>
{
   ...
   TH1D* x7away=(TH1D*)f1->Get("xZ11");
   TH1D* x7tank=(TH1D*)f2->Get("xZ11");

   TH1D* y7away=(TH1D*)f1->Get("yZ11");
   TH1D* y7tank=(TH1D*)f2->Get("yZ11");

   TH2D* xy7away=(TH2D*)f1->Get("xyZ11");
   TH2D* xy7tank=(TH2D*)f2->Get("xyZ11");
/*
