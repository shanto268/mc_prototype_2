...
AnaMuon::AnaMuon(TFile * fout) {
  std::string filename[2]= {"example.txt","example1.txt",/*"example2.txt"*/};
   ...
   //New Code start: SAS --> 11/20  
   histo1D["L0Ch_new"]=new TH1D("L0Ch_new","L0 Channel Numbers",15,0.,15.);
   histo1D["L0Ch_new"]->GetXaxis()->SetTitle("Ch number 0 to 10");
   histo1D["L0Ch_new"]->GetYaxis()->SetTitle("Number of hits");
   histo1D["L1Ch_new"]=new TH1D("L1Ch_new","L1 Channel Numbers",15,0.,15.);
   histo1D["L1Ch_new"]->GetXaxis()->SetTitle("Ch number 0 to 10");
   histo1D["L1Ch_new"]->GetYaxis()->SetTitle("Number of hits");
   histo1D["L2Ch_new"]=new TH1D("L2Ch_new","L2 Channel Numbers",15,0.,15.);
   histo1D["L2Ch_new"]->GetXaxis()->SetTitle("Ch number 0 to 10");
   histo1D["L2Ch_new"]->GetYaxis()->SetTitle("Number of hits");
   histo1D["L3Ch_new"]=new TH1D("L3Ch_new","L3 Channel Numbers",15,0.,15.);
   histo1D["L3Ch_new"]->GetXaxis()->SetTitle("Ch number 0 to 10");
