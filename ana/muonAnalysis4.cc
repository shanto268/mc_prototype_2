...
AnaMuon::AnaMuon(TFile * fout) {
   ...
   histo1D["Theta"]=new TH1D("Theta","Muon Angular Distribution",100.0,0.0,90.0);  
   ...
   for (int i=0; i<nz; i++) {
     ...
     histo2D[hname2]=new TH2D(hname2.c_str(),htitle2.c_str(),50,-xylim/2.0,xylim/2.0,50, 5000,xylim/2.0);
